...
TextureLight::TextureLight(ID3D11Device* dev)
...
void TextureLight::SendCamMatrices(const Matrix& view, const Matrix& proj)
{
...
void TextureLight::SetDirectionalLightParameters(const Vect& dir, const Vect& amb, const Vect& dif, const Vect& sp)
{
...
void TextureLight::SetPointLightParameters(int index, const Vect& pos, float r, const Vect& att, const Vect& amb, const Vect& dif, const Vect& sp)
{
...
void TextureLight::SetSpotLightParameters(int index, const Vect& pos, float r, const Vect& att, const Vect& dir, float spotExp, const Vect& amb, const Vect& dif, const Vect& sp)
{
...
void TextureLight::SendLightParameters(const Vect& eyepos)
{
	Data_LightParams dl;
...
void TextureLight::SendWorldAndMaterial(const Matrix& world, const Vect& amb, const Vect& dif, const Vect& sp)
{
...
void TextureLight::SendFogValues(const float& fogStart, const float& fogRange, const Vect& fogColor)
{
	FogValues fv;
...
void TextureLight::SetToContext(ID3D11DeviceContext* devcon)
{
...
void TextureLight::SetTextureResourceAndSampler(Texture* tex)
{
